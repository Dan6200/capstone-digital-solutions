...
We provide hosting and maintenance services to help businesses keep their websites and applications running smoothly and securely. Our hosting services involve providing the infrastructure and resources needed to store and deliver a website or application to customers. These include servers, storage, and bandwidth, as well as 24/7 monitoring to ensure that the website or application is always available to users.`,
            },
            {
                id: '2',
                text: `
We help ensure that a website or application remains up-to-date, secure, and functioning as intended. This can involve regular software updates, backups, and security checks to prevent downtime and protect against cyber threats. We also provide troubleshooting and technical support, helping businesses quickly resolve any issues that arise.`,
            },
            {
                id: '3',
                text: `
Our goal is to help businesses reduce their technical headaches and focus on their core business operations while ensuring that their online presence remains reliable and secure. We provide these services with a range of customizable options, allowing businesses to choose the level of support that best meets their needs and budget.
`,
            },
        ],
        id: '3',
    },
    {
        ...
        body: [
            {
                id: '1',
                text: `We provide search engine marketing (SEM) services to help businesses improve their online visibility and drive more qualified traffic to their website. SEM involves the use of paid advertising on search engines like Google and Bing, as well as other tactics like search engine optimization (SEO), to help businesses rank higher in search engine results pages (SERPs) and reach their target audience.`,
            },
            {
                id: '2',
                text: `Our SEM services may include keyword research, ad copywriting and design, bid management, and ongoing optimization and analysis. We also offer reporting and analytics services to help businesses track their performance and measure the success of their campaigns.`,
            },
            {
                id: '3',
                text: `Our goal is to help businesses reach their target audience when they're actively searching for products or services like theirs. By using targeted ads, we help businesses increase their online visibility, attract more qualified leads, and grow their business. Our SEM services can be customized to meet the specific needs and goals of each client, ensuring that they receive a highly effective and cost-efficient solution.`,
            },
        ],
        id: '4',
    },
        ...
        body: [
            {
                id: '1',
                text: `
We provide search engine optimization (SEO) services to help businesses improve their online visibility and ranking in search engine results pages (SERPs). SEO involves the use of on-page and off-page optimization tactics to improve a website's relevance and authority in the eyes of search engines like Google and Bing.`,
            },
            {
                id: '2',
                text: `
Our SEO services may include keyword research, on-page optimization, technical SEO audits, link building, and ongoing optimization and analysis. We also offer reporting and analytics services to help businesses track their performance and measure the success of their SEO efforts.`,
            },
            {
                id: '3',
                text: `
...
/*
    ...
    ,
    {
        ...
        body: [
            `
We provide services to help businesses effectively reach and engage with their target audience on social media platforms. Our services include strategy development, content creation and curation, community management, and advertising.`,

            `We work with clients to develop a customized social media marketing strategy, which outlines the goals, target audience, and key metrics for success. We also create and curate engaging and on-brand content, such as posts, images, videos, and stories, to be published on your business’s social media profiles.`,
            `
In addition to content creation and management, we provide community management services to monitor and respond to comments, messages, and reviews from social media users.`,
            `
...
Social media advertising allows businesses to reach a large, highly targeted audience on social media platforms, and to target specific demographics, interests, and behaviors. We use a range of targeting options, including demographic targeting, interest targeting, and retargeting, to ensure that each ad reaches the most relevant and engaged audience.
`,
            `
In addition to ad creation and management, we also provide reporting and analytics services to help businesses track the performance of their social media advertising efforts and measure the return on investment. Our goal is to help businesses reach their target audience and achieve their marketing goals, leveraging the power of social media platforms.
`,
        ],
    },
]
