...
const FooterBody: FC = () => {
    return (
        <section className="w-[90vw] sm:w-[80vw] md:w-[90vw] mx-auto mb-[40vw] lg:mb-[15vw] sm:mb-[30vw] text-center md:text-left">
            ...
            <div className="w-full md:w-[80%] lg:w-[60%] xl:w-[40%] mx-auto md:mx-0">
                <div className="flex flex-col sm:text-2xl md:text-xl lg:text-lg xl:text-md sm:flex-row md:gap-0 gap-[5vw] items-center text-center justify-between md:mx-0 mx-auto mb-[10vw] md:mb-[8vw] lg:mb-[6vw] xl:mb-[3vw] text-3xl text-black-800 font-paragraph">
